...
- To make the tiles/board I used dynamic styling and for- loop.
...
- Added a ` const [players,SetPlayers]=useState([]);` which can be many players of the game and it will display the score of players when the user fails.
- Added game difficulty by changing saturation on the odd color.
